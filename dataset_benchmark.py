...
from load_data_benchmark import load_twitch, load_fb100, DATAPATH
from utils import  rand_train_test_idx
from dataset_utils import even_quantile_labels, to_sparse_tensor, dataset_drive_url
...
try:
    ...
    print('cannot load google_drive_downloader, install it if needed.')
